...
public class TileFactory {
    private static final Map<Character, Supplier<Enemy>> ENEMIES =
            Map.ofEntries(
                    ...
                    // ────── Traps ──────
                    Map.entry('B', () -> new Trap('B', "Bonus Trap",      1,  1,  1, 250, 1, 5,Tile.Color.YELLOW)),
                        Map.entry('Q', () -> new Trap('Q', "Queen's Trap",   250, 50, 10, 100, 3, 7,Tile.Color.BLOOD_PURPLE)),
                    Map.entry('D', () -> new Trap('D', "Death Trap",     500,100, 20, 250, 1,10, Tile.Color.ASH_GREY))
            );
